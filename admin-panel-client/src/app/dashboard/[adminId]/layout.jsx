  ...
  const items = [
    {
      ...
      pathName: `/dashboard/${adminId}`,
    },
    {
      title: "Assigned Bus",
      icon: <MdOutlineAssignment className=" text-[1.3rem] " />,
      pathName: `/dashboard/${adminId}/assigned-bus`,
    },
    {
      title: "Bus Details",
      icon: <CgDetailsMore className=" text-[1.3rem] " />,
      pathName: `/dashboard/${adminId}/bus-details`,
    },
    {
      title: "Schedule",
      icon: <MdOutlineSchedule className=" text-[1.3rem] " />,
      pathName: `/dashboard/${adminId}/schedule`,
    },
    {
      title: "Driver Info",
      icon: <BsInfoSquare className=" text-[1.1rem] " />,
      pathName: `/dashboard/${adminId}/driver-info`,
    },
    {
      title: "Helper Info",
      icon: <BsInfoSquare className=" text-[1.1rem] " />,
      pathName: `/dashboard/${adminId}/helper-info`,
    },
    {
      title: "Trip Info",
      icon: <BsInfoSquare className=" text-[1.1rem] " />,
      pathName: `/dashboard/${adminId}/trip-info`,
    },
    {
      title: "Notification",
      icon: <IoMdNotificationsOutline className=" text-[1.4rem] " />,
      pathName: `/dashboard/${adminId}/notification`,
    },
    {
      title: "Feedback",
      icon: <VscFeedback className=" text-[1.4rem] " />,
      pathName: `/dashboard/${adminId}/feedback`,
    },
    {
      title: "Pickup Points",
      icon: <MdWheelchairPickup className=" text-[1.4rem] " />,
      pathName: `/dashboard/${adminId}/pickup-points`,
    },
    {
      title: "General Users",
        ...
        <div className=" relative flex min-h-[100vh] w-full overflow-hidden">
          ...
          <div className=" flex-1 max-w-[100vw] ">
            <div className=" flex items-center justify-between w-full px-5 h-[4.5rem] bg-[#2C2C2C]  ">
              ...
              <ProfileModal adminId={adminId} isPathInItems={isPathInItems} />
            </div>
