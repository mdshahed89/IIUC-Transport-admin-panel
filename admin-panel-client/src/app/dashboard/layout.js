...
export default function DashboardLayout({ children, params }) {
  ...
  return (
    <div className=" font-Georama ">
      <div className="">
        <div className=" relative flex rounded-md min-h-[100vh] mb-5">
          <div
            ref={optionRef}
            className={` ${
              sideBarOpen ? "inboxSideBarOpen w-[20rem] " : "inboxSideBarClose w-[3.5rem] "
                      ...
                      onClick={()=>{
                        ...
                        className={`cursor-pointer ${
                          currentPath === item.pathName
                            ...
                            : "text-[#fff]"
                        } group flex items-center gap-4 text-[1.1rem] hover:bg-green-50 rounded-md hover:text-[#00712D] px-3 ${sideBarOpen ? "" : "justify-center"}  py-2   transition-all duration-300 ease-in-out font-medium  `}
                      >
                        <div
                          className={`${
                            currentPath === item.pathName
          ...
          <div className="flex-1 md:ml-0 ml-[3rem] w-full ">
            <div className=" flex items-center justify-between w-full px-5 h-[4.5rem] bg-[#2C2C2C]  ">
              <h3 className=" text-[2rem] font-medium text-white ">Dashboard</h3>
